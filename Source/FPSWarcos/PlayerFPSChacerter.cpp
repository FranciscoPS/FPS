...
#include "PlayerFPSChacerter.h"
#include "AbilitySystemComponent.h"
#include "FPSAttributeSet.h"

// Sets default values
APlayerFPSChacerter::APlayerFPSChacerter()
{
...
UAbilitySystemComponent* APlayerFPSChacerter::GetAbilitySystemComponent() const
{
	return AbilitySystemComponent;
}

// Called when the game starts or when spawned
void APlayerFPSChacerter::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void APlayerFPSChacerter::Tick(float DeltaTime)
{
...
void APlayerFPSChacerter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
